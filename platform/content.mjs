...
const MACRO = [
  {
    ...
    files: ['Module-00-Pourquoi-compta-francaise.md', 'Module-01-Environnement-comptable-francais.md', 'Module-02-Bases-comptabilite-PCG.md', 'Module-03-Organisation-dossier-externalise.md', 'Module-04-Saisie-comptable-pratique.md', 'Module-1P-Principes-particularites.md', 'Module-1F-Externalisation-FacturX.md', 'Module-MEMENTO-Reference.md'],
    quiz: 'm01'
  },
  {
