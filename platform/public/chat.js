  ...
  var FAQ = [
    { key: 'prix', chip: '💰 Prix & offres', kw: ['prix', 'tarif', 'coute', 'coût', 'cout', 'combien', 'offre', 'pack', 'cher', 'ariary', 'ar '],
      a: (PROMO
        ...
        : 'Les modules sont <b>à partir de 25&nbsp;000&nbsp;Ar</b> (Module 1 : 25&nbsp;000&nbsp;Ar), et il existe un <b>pack complet</b> avantageux. Détail et aperçu de chaque module : <a href="/programme">page Programme</a>.') },
    { key: 'inscription', chip: '🎓 S\'inscrire', kw: ['inscri', 'compte', 'creer', 'créer', 's\'inscrire', 'rejoindre', 'commencer'],
      a: 'Cliquez sur <a href="/inscription"><b>S\'inscrire</b></a>, remplissez le formulaire (prérequis&nbsp;: <b>BAC+2 en comptabilité</b>, attestation sur l\'honneur). Vous pourrez ensuite consulter les <b>aperçus des modules</b> et débloquer ceux de votre choix' + (PROMO ? ' — et pendant la promo, TOUS les modules sont débloqués !' : '') + '.' },
    { key: 'module1', chip: '📚 Découvrir le Module 1', kw: ['gratuit', 'module 1', 'module1', 'essai', 'tester', 'découvrir', 'decouvrir'],
      a: (PROMO ? '🎁 Pendant la promo, <b>TOUS les modules (1 à 6)</b> sont offerts après une inscription gratuite. <a href="/apercu?m=mod1">Commencer →</a>' : 'Le <b>Module&nbsp;1 — Fondamentaux de la comptabilité française</b> (25&nbsp;000&nbsp;Ar) pose toutes les bases : environnement, PCG, saisie. <a href="/apercu?m=mod1">Voir l\'aperçu →</a>') },
