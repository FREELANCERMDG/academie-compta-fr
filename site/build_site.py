...
/* Feuille de cours : reste claire et lisible (CERFA/simulateurs/quiz intacts), encadrée de neon */
.content.card{background:#fff !important;border:1px solid rgba(56,232,255,.30) !important;
  box-shadow:0 26px 64px rgba(0,0,0,.48),0 0 0 1px rgba(56,232,255,.12),0 0 44px -14px rgba(56,232,255,.38) !important}
.quiz{background:#fff !important;border:1px solid rgba(56,232,255,.25) !important;box-shadow:0 18px 48px rgba(0,0,0,.42),0 0 30px -12px rgba(56,232,255,.30) !important}
