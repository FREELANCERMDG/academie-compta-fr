...
(function () {
  ...
  var CSS = [
    ...
    ".cerfa-dl{display:inline-block;background:#1F4E78;color:#fff;text-decoration:none;font-weight:700;font-size:12px;padding:5px 11px;border-radius:7px;margin:0 6px 6px 0}",
    ".cerfa-dl.alt{background:#eef3fb;color:#1F4E78;border:1px solid #cdd8e8}",
    ".cerfa-dl:hover{opacity:.9}",
  ...
  var CERFA = {
    ca3: { no: "3310-CA3-SD", titre: "TVA — Régime réel normal (CA3, mensuelle/trimestrielle)", pdf: "/public/cerfa/3310-CA3-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/3310-ca3-sd/taxe-sur-la-valeur-ajoutee-et-taxes-assimilees-regime-du-reel-normal",
    ...
    ca12: { no: "3517-S-SD", titre: "TVA — Régime simplifié (CA12, déclaration annuelle)", pdf: "/public/cerfa/3517-S-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/3517-s-sd/tva-regime-simplifie-dimposition-ca12",
    ...
    "2065": { no: "2065-SD", titre: "Déclaration de résultat — Impôt sur les sociétés (IS)", pdf: "/public/cerfa/2065-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2065-sd/impot-sur-les-societes",
    ...
    "2031": { no: "2031-SD", titre: "Déclaration de résultat — BIC à l'impôt sur le revenu (IR)", pdf: "/public/cerfa/2031-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2031-sd/impot-sur-le-revenu",
    ...
    "2058a": { no: "2058-A-SD", titre: "Détermination du résultat fiscal (réel normal)", pdf: "/public/cerfa/2058-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2058-sd/liasse-fiscale-des-societes-fiscalement-integrees",
    ...
    "2033b": { no: "2033-B-SD", titre: "Compte de résultat simplifié + résultat fiscal (RSI)", pdf: "/public/cerfa/2033-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2033-sd/liasse-bicsi-regime-rsi-tableaux-ndeg-2033-sd-2033-g-sd",
    ...
    "2035": { no: "2035-SD (A/B)", titre: "BNC — Déclaration contrôlée (professions libérales)", pdf: "/public/cerfa/2035-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2035-sd/revenus-non-commerciaux-et-assimiles-regime-de-la-declaration-controlee",
    ...
    das2: { no: "DAS2 (n° 2460)", titre: "État des honoraires, commissions, courtages…", pdf: "/public/cerfa/DAS2.pdf", gouv: "https://www.impots.gouv.fr/formulaire/das2/etat-des-honoraires-vacations-commissions-courtages-ristournes-et-jetons",
    ...
    cfe: { no: "1447-C / 1447-M-SD", titre: "CFE — Cotisation Foncière des Entreprises", pdf: "/public/cerfa/1447-C-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/1447-c-sd/declaration-initiale-de-cotisation-fonciere-des-entreprises",
    ...
    "2139": { no: "2139-SD", titre: "Bénéfices Agricoles — réel simplifié (BA)", pdf: "/public/cerfa/2139-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2139-sd/benefices-agricoles-regime-reel-simplifie-dimposition-declaration",
    ...
    "2072": { no: "2072-S-SD", titre: "SCI à l'IR — revenus fonciers", pdf: "/public/cerfa/2072-S-SD.pdf", gouv: "https://www.impots.gouv.fr/formulaire/2072-s-sd/declaration-des-societes-immobilieres-non-soumises-limpot-sur-les-societes",
  ...
  function render(el){
    ...
    h += "</div><div class='cerfa-note'>"
      + (f.pdf ? "<a class='cerfa-dl' href='" + escA(f.pdf) + "' target='_blank' rel='noopener'>📄 CERFA officiel (PDF)</a>" : "")
      + (f.gouv ? "<a class='cerfa-dl alt' href='" + escA(f.gouv) + "' target='_blank' rel='noopener'>🔗 impots.gouv.fr</a>" : "")
      + "<br>💡 Survolez (ou touchez) chaque case pour l'explication et le remplissage. Illustration pédagogique — le <b>CERFA officiel</b> (bouton ci‑dessus) fait foi.</div></div>";
    el.innerHTML = h;
  }
