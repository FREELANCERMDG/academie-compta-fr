...
### 🚘 Bien lire la carte grise pour l'IK

<svg viewBox="0 0 720 384" width="100%" role="img" aria-label="Carte grise : la case P.6 donne la puissance fiscale" font-family="Arial,Helvetica,sans-serif"><rect x="6" y="6" width="708" height="372" fill="#eef3fa" stroke="#c7d3e2"/><rect x="6" y="6" width="708" height="46" fill="#1F4E78"/><text x="22" y="35" fill="#ffffff" font-size="16.5" font-weight="bold">CERTIFICAT D'IMMATRICULATION — « carte grise »</text><text x="698" y="34" fill="#cfe0f3" font-size="11" text-anchor="end">schéma pédagogique · valeurs d'exemple</text><rect x="22" y="64" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="34" y="83" font-size="11.5"><tspan font-weight="bold" fill="#16307a">A</tspan><tspan fill="#7a8694"> N° immatriculation</tspan></text><text x="34" y="103" font-size="14" font-weight="bold" fill="#16263a">AA-123-BB</text><rect x="252" y="64" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="264" y="83" font-size="11.5"><tspan font-weight="bold" fill="#16307a">B</tspan><tspan fill="#7a8694"> 1re immatriculation</tspan></text><text x="264" y="103" font-size="14" font-weight="bold" fill="#16263a">12/03/2021</text><rect x="482" y="64" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="494" y="83" font-size="11.5"><tspan font-weight="bold" fill="#16307a">P.3</tspan><tspan fill="#7a8694"> Carburant</tspan></text><text x="494" y="103" font-size="14" font-weight="bold" fill="#16263a">ES (essence)</text><rect x="22" y="122" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="34" y="141" font-size="11.5"><tspan font-weight="bold" fill="#16307a">D.1</tspan><tspan fill="#7a8694"> Marque</tspan></text><text x="34" y="161" font-size="14" font-weight="bold" fill="#16263a">(marque)</text><rect x="252" y="122" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="264" y="141" font-size="11.5"><tspan font-weight="bold" fill="#16307a">D.3</tspan><tspan fill="#7a8694"> Modèle</tspan></text><text x="264" y="161" font-size="14" font-weight="bold" fill="#16263a">(modèle)</text><rect x="482" y="122" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="494" y="141" font-size="11.5"><tspan font-weight="bold" fill="#16307a">S.1</tspan><tspan fill="#7a8694"> Nb de places</tspan></text><text x="494" y="161" font-size="14" font-weight="bold" fill="#16263a">5</text><rect x="22" y="180" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="34" y="199" font-size="11.5"><tspan font-weight="bold" fill="#16307a">P.1</tspan><tspan fill="#7a8694"> Cylindrée</tspan></text><text x="34" y="219" font-size="14" font-weight="bold" fill="#16263a">1149 cm³</text><rect x="252" y="180" width="218" height="50" fill="#f7fafd" stroke="#d6e0ec"/><text x="264" y="199" font-size="11.5"><tspan font-weight="bold" fill="#16307a">P.2</tspan><tspan fill="#7a8694"> Puissance réelle</tspan></text><text x="264" y="219" font-size="14" font-weight="bold" fill="#16263a">74 kW</text><rect x="22" y="242" width="678" height="88" rx="10" fill="#fff3df" stroke="#E8A13A" stroke-width="2.5"/><text x="42" y="280" font-size="23" font-weight="bold" fill="#9a5b00">P.6</text><text x="42" y="304" font-size="11.5" fill="#8a6a2a">puissance fiscale</text><line x1="150" y1="256" x2="150" y2="316" stroke="#e6c89a" stroke-width="1.5"/><text x="170" y="296" font-size="30" font-weight="bold" fill="#9a5b00">5 CV</text><line x1="290" y1="256" x2="290" y2="316" stroke="#e6c89a" stroke-width="1.5"/><text x="308" y="282" font-size="13.5" font-weight="bold" fill="#7a4e00">➜ La case à lire pour l'IK : elle donne</text><text x="308" y="304" font-size="13.5" font-weight="bold" fill="#7a4e00">la tranche du barème (3 CV et moins → 7 CV et +).</text><text x="22" y="356" font-size="11.5" fill="#6b7785">Astuce : <tspan font-weight="bold" fill="#16307a">P.3 = EL</tspan> (100 % électrique) → <tspan font-weight="bold">+20 %</tspan> sur l'IK · ne pas confondre <tspan font-weight="bold">P.6</tspan> (CV fiscaux) et <tspan font-weight="bold">P.2</tspan> (kW réels).</text></svg>

**Comment la lire (pour l'IK) :**
- **P.6 — Puissance fiscale (chevaux fiscaux, « CV »)** : c'est **LA** case à lire. Elle fixe la tranche du barème : **3 CV et moins · 4 CV · 5 CV · 6 CV · 7 CV et plus**.
- **P.3 — Carburant** : `ES` = essence, `GO` = gazole (diesel), `EL` = **100 % électrique**, `EH`/`EE`/`GH` = hybride, `GP`/`GN` = GPL/GNV. Si **`EL`** → **majoration +20 %** sur l'indemnité.
- ⚠️ **Ne pas confondre** : **P.6** = chevaux *fiscaux* (sert au barème) ; **P.2** = puissance *réelle* en kW. Seule **P.6** entre dans le calcul.
- **Carte grise étrangère / sans case P.6** : réclamer un justificatif de puissance fiscale (ou l'estimer) avant de retenir une tranche.
