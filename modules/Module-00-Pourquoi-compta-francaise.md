...
- Résultat : une **forte demande** de collaborateurs formés à la **méthode française**.

## 🛤️ Deux voies pour travailler avec la France, depuis Mada
1. **Salarié** d'un cabinet d'externalisation à Antananarivo (Pennylane, TVA, liasse… pour des clients français).
2. **Freelance** : vos propres clients (cabinets français), facturés **en euros**, en travaillant de chez vous.

## 📈 Vos débouchés et votre évolution
**Collaborateur → Réviseur → Chef de mission → Superviseur → Freelance / entrepreneur.**
Chaque niveau = plus de responsabilités… et de revenus.

## 💰 Fourchettes de rémunération (exemples indicatifs)
| Profil | Rémunération indicative |
|---|---|
| Collaborateur débutant (Antananarivo) | salaire d'entrée du métier |
| **Réviseur confirmé** (cabinet d'externalisation) | **≈ 1 600 000 Ar / mois** |
| **Freelance** avec clients cabinets français | **≈ 800 € / mois** (et plus selon le portefeuille) |

> *Montants indicatifs : ils varient selon l'expérience, l'employeur, le portefeuille de clients et l'implication.*

## 🎓 Ce que cette formation vous apporte
- La **vraie méthode française** : PCG, TVA, liasse fiscale, clôture, révision.
- Le **logiciel Pennylane** pas à pas (vidéos + pratique).
...
## ✅ Prêt à commencer ?
Le **Module 1 est gratuit** : découvrez les fondamentaux, faites le quiz, et voyez par vous‑même. Votre carrière comptable internationale commence **ici**.
